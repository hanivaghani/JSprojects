...
async function initializeModel() {
    try {
        classifier = await ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/DUuMwKAuj/', () => {
            isModelLoaded = true;
            modelStatus.textContent = 'By Hani...';
            modelStatus.style.backgroundColor = '#FFFFFF';
